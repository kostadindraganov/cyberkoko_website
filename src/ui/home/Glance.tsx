...
// Define types for the refs array
...
const Glance = () => {
    ...
    // Type the element parameter
    const addToRefs = (el: CardElement | null) => {
    ...
    useEffect(() => {
        if (!isHovering) {
            cardRefs.current.forEach((card: CardElement) => {
                gsap.to(card, {
                    x: 0,
                    y: 0,
                    rotationY: 0,
                ...
                const content = card.querySelector('video, img') as HTMLElement;
                if (content) {
                    gsap.to(content, {
                        x: 0,
                        y: 0,
            ...
            <div className='flex flex-col md:flex-row gap-10'>
                ...
                <div className='flex flex-col w-full gap-10 items-start'>
                    ...
                    >
                        ...
                        <Image src='/img/hero-boy.png' alt='card-2' fill className='object-cover object-center h-auto -mt-40 md:-mt-72' />
                    </div>
